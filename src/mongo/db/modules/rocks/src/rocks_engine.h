...
namespace mongo {
    ...
    public:
        ...
        shannon::DB* getDB() { return _db.get(); }
        const shannon::DB* getDB() const { return _db.get(); }
        //size_t getBlockCacheUsage() const { return _block_cache->GetUsage(); }
        //std::shared_ptr<shannon::Cache> getBlockCache() { return _block_cache; }
        ...
        //shannon::Statistics* getStatistics() const {
    ...
    private:
        ...
        shannon::Options _options() const;

        std::string _path;
        std::unique_ptr<shannon::DB> _db;
        std::shared_ptr<shannon::Cache> _block_cache;
        int _maxWriteMBPerSec;
        //std::shared_ptr<shannon::RateLimiter> _rateLimiter;
        // can be nullptr
        //std::shared_ptr<shannon::Statistics> _statistics;
