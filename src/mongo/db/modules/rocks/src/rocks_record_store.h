...
namespace mongo {
    ...
    public:
        RocksRecordStore(StringData ns, StringData id, shannon::DB* db,
        ...
        static shannon::Comparator* newRocksCollectionComparator();
    ...
    private:
        ...
        public:
            Cursor(OperationContext* opCtx, shannon::DB* db, std::string prefix,
        ...
        private:
            ...
            RecordId _lastLoc;
            std::unique_ptr<shannon::Iterator> _iterator;
            std::string _seekExactResult;
            void positionIterator();
            shannon::Iterator* iterator();
        };

        static RecordId _makeRecordId( const shannon::Slice& slice );

        static RecordData _getDataFor(shannon::DB* db, const std::string& prefix,
        ...
        static shannon::Slice _makeKey(const RecordId& loc, int64_t* storage);
