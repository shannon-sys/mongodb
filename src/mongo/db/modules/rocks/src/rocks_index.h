...
namespace mongo {
    ...
    public:
        RocksIndexBase(shannon::DB* db, std::string prefix, std::string ident, Ordering order,
    ...
    public:
        RocksUniqueIndex(shannon::DB* db, std::string prefix, std::string ident, Ordering order,
    ...
    public:
        RocksStandardIndex(shannon::DB* db, std::string prefix, std::string ident, Ordering order,
                           const BSONObj& config);
